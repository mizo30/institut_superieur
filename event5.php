...
<html lang="en">
  <head>
    ...
    <title>isik- Event Details</title>
  ...
  &nbsp;&nbsp;&nbsp;<img src="./assets/img/log/287069135_5170503759723453_8699168065751078212_n.jpg" width="40px" alt="">
    ...
    <main id="main">
      ...
      <div
        ...
        style="background-image: url('assets/img/101(3).jpg')"
      >
        <div
                ...
                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center">
                      ...
                      <a href="blog-details.php">John Doe</a>
                    </li>
                    <li class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center">
                      ...
                      <a href="blog-details.php">12 Comments</a>
                    </li>
                  </ul>
                </div>
                <!-- End meta top -->
              ...
              <div class="sidebar">
                ...
                <div class="sidebar-item categories">
                  ...
                  <ul class="mt-3">
                    ...
                    <li>
                      <a href="#">Conferences <span>(5)</span></a>
                    </li>
                    <li>
                      <a href="#">Seminaires <span>(22)</span></a>
                    </li>
                    <li>
                      <a href="#">Ateliers <span>(8)</span></a>
                    </li>
                    <li>
                  ...
                  <div class="mt-3">
                    ...
                    <div class="post-item">
                      ...
                      <div>
                        <h4>
                          <a href="./event2.php"
                            >Vous avez une idee de projet??</a
                          >
                        </h4>
                    ...
                    <div class="post-item">
                      ...
                      <div>
                        <h4>
                          <a href="./event3.php"
                            >Session de dormation de la solution antipalage</a
                          >
                        </h4>
                        <time datetime="2023-03-09">Mars 9, 2023</time>
                      </div>
                    </div>
                    <!-- End recent post item-->
                    ...
                    <div class="post-item">
                      ...
                      <div>
                        ...
                        <time datetime="2023-02-22">fev 22, 2023</time>
                      </div>
                    </div>
                    <!-- End recent post item-->
                    ...
                    <div class="post-item">
                      ...
                      <div>
                        ...
                        <time datetime="2023-04-11">Avr 11, 2023</time>
                      </div>
                    </div>
                    <!-- End recent post item-->
                  </div>
