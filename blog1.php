        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event1.php" class="readmore stretched-link"
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event2.php" class="readmore stretched-link"
                    ><span>Read More</span><i class="bi bi-arrow-right"></i
                  ></a>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event3.php" class="readmore stretched-link"
                    ><span>Read More</span><i class="bi bi-arrow-right"></i
                  ></a>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event4.php" class="readmore stretched-link"
                    ><span>Read More</span><i class="bi bi-arrow-right"></i
                  ></a>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event5.php" class="readmore stretched-link"
                    ><span>Read More</span><i class="bi bi-arrow-right"></i
                  ></a>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="post-item position-relative h-100">
                ...
                <div class="post-content d-flex flex-column">
                  ...
                  <a href="./event6.php" class="readmore stretched-link"
                    ><span>Read More</span><i class="bi bi-arrow-right"></i
                  ></a>
                </div>
              </div>
          ...
          <div class="blog-pagination">
            <ul class="justify-content-center">
              <li class="active"><a href="./blog1.php">1</a></li>
